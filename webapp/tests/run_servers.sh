...
bwtestserver -s 1-ff00:0:112,[127.0.0.2]:30100 &
...
imageserver -s 1-ff00:0:112,[127.0.0.2]:42002 &
...
python3 ${GOPATH}/src/github.com/netsec-ethz/scion-apps/sensorapp/sensorserver/timereader.py | sensorserver -s 1-ff00:0:112,[127.0.0.2]:42003 &

# test pingpong server
cd $SC
echo "Running test pingpongserver..."
./bin/pingpong -mode server -local 1-ff00:0:112,[127.0.0.2]:40002 &
